...
generate_pdp_plot <- function(model, pred_var, var_name, train_data, y_name="Predicted bike rentals", grid_resolution = 20) {
  ...
  pdp_plot <- ggplot(pdp_df) +
    ...
    theme_minimal() +
    labs(title = paste("Partial Dependency Plot for", var_name),
         x = pred_var, y = y_name)
...
```{r}
pdp_plot_bedrooms <- generate_pdp_plot(rf_house, "bedrooms", "Bedrooms" ,house_new, "Predicted Price")
print(pdp_plot_bedrooms)

pdp_plot_bathrooms <- generate_pdp_plot(rf_house, "bathrooms", "Bathrooms" ,house_new, "Predicted Price")
print(pdp_plot_bathrooms)

pdp_plot_sqft_living <- generate_pdp_plot(rf_house, "sqft_living", "SQFT living",house_new, "Predicted Price")
print(pdp_plot_sqft_living)

pdp_plot_floors <- generate_pdp_plot(rf_house, "floors", "Floors", house_new, "Predicted Price")
